            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a href="#"><img class="brand-logo-light" src="global/img/sdc-letters-white.png" alt="" style="width:50%;margin:auto;"/></a></div>
                </div>
                <div class="rd-navbar-main-element"> 
                  <div class="rd-navbar-nav-wrap">
                    ...
                    <ul class="rd-navbar-nav">
                      ...
                      <li class="rd-nav-item" style="display:none;"><a class="rd-nav-link" id="contact-form-btn" href="#contact-form">Contact Form</a>
                      </li>
                    </ul><a class="button button-primary" href="#contact">make an appointment</a>
                  </div>
                </div>
              </div>
            </div>
